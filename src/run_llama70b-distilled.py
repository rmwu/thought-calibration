...
if __name__ == "__main__":
    ...
    paths = [
        #"inputs/s1_truncated_llama3.3.json"
        #"inputs/s1_embed_llama3.3.json",
    ...
    pipe = pipeline(f"{HF_HOME}/hub/models--deepseek-ai--DeepSeek-R1-Distill-Llama-70B/snapshots/b1c0b44b4369b597ad119a196caf79a9c40e141e",
    ...
    for fp_prompts in paths:
        ...
        for batch in prompts_batched[start:]:
            ...
            if len(outputs) >= save_batch_size:
                ...
                fp_out = fp_out.replace("inputs/", "outputs-llama/")
